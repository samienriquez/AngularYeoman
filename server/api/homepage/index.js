...
var createAzureBlob = function(imageName, localPath,cb){
  blobSvc.createBlockBlobFromLocalFile('photos', imageName, localPath, function(error, result, response) {
    if (!error) {
      ...
      easyimg.rescrop({
        ...
        function(image) {
          ...
          uploadImage(req, res, newFileName, function() {
            console.log("Sending_photo_back");
            file.path = 'http://sami915.blob.core.windows.net/photos/preview_' + newFileName;
